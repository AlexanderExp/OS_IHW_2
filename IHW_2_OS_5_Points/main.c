...
sem_t *room_sem;            // именованный семафор для доступных номеров
...
int main() {
    ...
    // создаем именованный семафор для доступных номеров
    room_sem = sem_open("/room_sem", O_CREAT, 0666, MAX_ROOMS);
